...
# Определяем високосный ли год: если остаток от деления года на 4 равен 0 и остаток от деления на 100 = 0 и остаток от деления на 400 = 0.
...
# STEP = 2
# limit = num - STEP
# # (чтобы начать счетчик с нуля, вместо записи count = 0, т.к. шаг мы задали через константу.)
# count = -STEP
