...
""""""
"""
Кейсов всего два: test_first_num и test_first_chr. И каждый из них использует свои фикстуры. 
Но давайте обо всём сверху вниз.
"""
"""
➢ Фикстура get_file
...
!!! Для Pytest можно использовать не функции, а классы и методы (как для юниттеста). тут класс 
тестов - без родителя (в отличие от unittest) - см. дополнительно в HW_14
