...
"""
Как получить инфо о модуле или его методе: зажимаем Ctrl + наводим в файле курсором на нужный
модуль или его метод - переход в справку. Выход - закрыть окошко со справкой.
"""
...
"""
"""
метод argv работает, по сути, как input из командной строки. Дает параметры в виде строк, а в файле
прописываем, что с ними делать 
"""
# МОДУЛ RANDOM
...
Т.е. seed() используется, чтобы смоделировать(повторить) один и тот же "случайный" набор данных
"""
