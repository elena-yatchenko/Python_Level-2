...
- sample(population, k, *, counts=None) - выборка в k элементов из 
population (уникальных)

- choices((population, k, *, counts=None)- выборка в k элементов из 
...
""" 
counts принимает на вход список, который должен содержать столько же элементов, 
