...
# print(*sys.path, sep='\n')
"""
Переменная sys.path (путь) формируется динамически. В зависимости от того, с какого 
...
внутри которого перечисляются имена объектов - переменных, функций и проч. (в кавычках '', т.е. СТРОКОВЫЕ значения)
