...
class InvalidTextError(ValueError):
    ...
    def __str__(self):
        return f"Текст {self.text} не является строкой или является пустой строкой"
...
class InvalidNumberError(ValueError):
    ...
    def __str__(self):
        return f"Число {self.number} не является положительным числом или числом с плавающей запятой (float)"
