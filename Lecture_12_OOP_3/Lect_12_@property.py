# ДЕКОРАТОР @PROPERTY (переводим МЕТОД класса В АТРИБУТ (т.е. не нужно вызывать
# со скобками, как метод, а вызывается просто через точку, как атрибут))
...
# АНТИПАТТЕРН ГЕТТЕРА, СЕТТЕРА И ДЕЛЕЙТЕРА
