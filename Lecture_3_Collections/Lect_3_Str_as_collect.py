...
"""
* метод split() - разбивает строку на отдельные элементы в соответствии с
разделителем и помещает РЕЗУЛЬТАТ в СПИСОК.


* метод join() - Метод join принимает на вход итерируемую последовательность и соединяет все её
элементы в строку, разделяя каждый текстом, к которому применён метод. В
некоторой степени join противоположен split. При этом в начале и в конце получившейся строки разделителя не будет.
