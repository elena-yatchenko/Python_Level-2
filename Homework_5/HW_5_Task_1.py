...
# !!! решение с семинара (классное, но для нормально прописанных путей)

def split_file_path(file_path):
    # путь к директории, имя файла
    dir_path, full_filename = file_path.rsplit("/", 1)
...
print(split_file_path(file_path = '/home/user/docs/my.file.with.dots.txt'))