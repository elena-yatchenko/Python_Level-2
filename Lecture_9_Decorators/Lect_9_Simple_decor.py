...
""" Выводит одно и то же значение, т.к. в обертке идет проверка, и если введенные аргументы уже есть в словаре, фунцкия не выполняется, а выводится уже имеющееся 
